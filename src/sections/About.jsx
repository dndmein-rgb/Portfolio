...
backend architecture, performance, and seamless user experience. My
stack includes React, Next.js, Node.js, Express.js, MongoDB,
TypeScript, and Tailwind CSS, allowing me to build fast, reliable,
and full stack applications.
            ...
            <div className="mt-6 grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4 max-w-xl">
              {[
                ...
                { label: "Focus", value: "Web Apps & UI/UX" },
              ].map((item, i) => (
                <motion.div
                  key={i}
        ...
        <div className="grid md:grid-cols-1">
          ...
          >
            ...
            <p className="text-gray-300 leading-relaxed text-base sm:text-lg">
              ...
              scalable web applications with clean UI and smooth user
              experiences.
            </p>

            <p className="mt-4 text-gray-400 text-base sm:text-lg">
              I enjoy turning ideas into fast, user-friendly products that solve
              real problems.
            </p>
          </motion.div>
        </div>
