...
const experiences = [
{
  ...
  duration: "2025",
  description:
    "Built responsive web apps, integrated AI features, and improved performance.",
},

{
  role: "Full Stack Developer Intern",
  company: "Django Services Pvt Limited",
  duration: "2026",
  description:
    "Worked on full stack web development and scalable web applications.",
},
